...
# =================================================================================
# REFACTOR SUMMARY:
# 1. SIMPLIFIED PATHS: Removed the arrays for TRAIN_CUBES, VAL_CUBES, etc.
#    You only need to define the single path to your Zarr data cube now.
# 2. UPDATED ARGUMENTS: The `python train_cloud_imputation.py` command now uses
#    the simplified `--zarr_path` argument, matching the refactored script.
# =================================================================================
...
python train_cloud_imputation2.py \
    --zarr_path "$ZARR_PATH" \
